...
export const SITE = {
  ...
  bio:
    ...
    'charts and written analysis for an audience over 100,000. My interests ' +
    'sit where analytical thinking meets visual communication: statistical ' +
    'analysis, dashboarding, business intelligence and machine learning. ' +
