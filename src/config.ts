...
export const SITE = {
  ...
  bio:
    ...
    'I spent an exchange semester at Ulm University of Applied Sciences studying ' +
    'machine learning, business analytics and data visualisation. Most of the work ' +
    'is the unglamorous half of analysis — checking whether a number survives ' +
    'contact with the raw data before anyone builds an argument on it.',
  links: [
